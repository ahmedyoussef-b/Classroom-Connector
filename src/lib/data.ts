...
export const CAREERS: Career[] = [
  {
    ...
    theme: {
      ...
      icon: Stethoscope,
      cursor: 'cursor-help', // Using 'help' as a syringe is not standard
    },
  },
  {
    id: 'pilote',
